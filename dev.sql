...
vector ('par_1', 'par_2'), 
2, 
'/fct/rdfdesc/description.vsp?g=http://vocab.data.gov/%s&%s', 
vector ('par_1', 'par_2'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/fct/rdfdesc/description.vsp?g=http://vocab.data.gov/%U', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=application/rdf%%2Bxml', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=text/rdf%%2Bn3', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=application/json', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=application/rdf%%2Bjson', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=text/csv', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=text/plain', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=application/atom%%2Bxml', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=application/odata%%2Bjson', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/fct/rdfdesc/description.vsp?g=http://vocab.data.gov/%s', 
vector ('par_1'), 
NULL, 
'text/html', 
1, 
...
vector ('par_1', 'par_2'), 
2, 
'/fct/rdfdesc/description.vsp?g=http://vocab.data.gov/def/%s&%s', 
vector ('par_1', 'par_2'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/fct/rdfdesc/description.vsp?g=http://vocab.data.gov/def/%s', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2F%U%%3E&format=application/odata%%2Bjson', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1', 'par_2'), 
2, 
'/fct/rdfdesc/description.vsp?g=http://vocab.data.gov/id/%s&%s', 
vector ('par_1', 'par_2'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/fct/rdfdesc/description.vsp?g=http://vocab.data.gov/id/%s', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2Fid%%2F%s%%3E&format=text/rdf%%2Bn3', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2Fid%%2F%s%%3E&format=application/json', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2Fid%%2F%s%%3E&format=application/rdf%%2Bjson', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2Fid%%2F%s%%3E&format=text/csv', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2Fid%%2F%s%%3E&format=application/rdf%%2Bxml', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2Fid%%2F%s%%3E&format=text/plain', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2Fid%%2F%s%%3E&format=application/atom%%2Bxml', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
...
vector ('par_1'), 
1, 
'/sparql?query=define%%20sql%%3Adescribe-mode%%20%%22CBD%%22%%20describe%%20%%3Chttp%%3A%%2F%%2Fvocab.data.gov%%2Fid%%2F%s%%3E&format=application/odata%%2Bjson', 
vector ('par_1'), 
NULL, 
NULL, 
1, 
